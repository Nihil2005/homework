...
const Fotter = () => {
  return (
    <div>
        <footer class="bg-white w-full py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between flex-col py-8 min-[500px]:py-14 gap-8 min-[500px]:gap-16 lg:gap-0 lg:flex-row">
                ...
                <div class="block lg:max-w-md">
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="py-3.5 px-7 bg-indigo-600 shadow-md rounded-full text-white font-semibold hover:bg-indigo-700">Subscribe</button>
                    </div>
                </div>
            </div>
            <div class="py-9 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
                    <span class="text-sm text-gray-500 ">©<a href="#">Solvera</a> 2024, All rights reserved.</span>
